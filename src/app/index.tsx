        ...
        >
          ...
          <View style={[styles.heroBanner, { backgroundColor: theme.backgroundElement }]}>
            ...
            <ThemedText type="small" themeColor="textSecondary" style={styles.heroSubtitle}>
              Discover our curated collection of premium keyboards for every style and workflow.
            </ThemedText>
          </View>
          ...
          <View style={styles.sectionHeader}>
            ...
            <ThemedText type="small" themeColor="textSecondary" style={styles.sectionLink}>
              View All
            </ThemedText>
          </View>
